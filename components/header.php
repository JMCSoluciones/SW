...
<header> 
  ...
  <nav class="menu"> 
    <section class="menu__container"> <img class="menu__logo" src="images/iconos/logo-amarillo.svg"/>
      <ul class="menu__links"> 
        <li class="menu__item"> <a class="menu__link" href="index.php">Inicio</a></li>
        <li class="menu__item"> <a class="menu__link" href="catalogo.php">Productos</a></li>
        <li class="menu__item"> <a class="menu__link" href="cotiza_gral.php">Cotizar</a></li>
